...
AP.init({
    playList: [
        {'icon': iconImage,
            'title': 'How to Reap for a Spiritual Harvest 3/15/15 AM - Rick Johnson',
                'file': 'http://www.friendshipbc.net/uploads/2/6/9/7/2697765/3_15_2015_am_rick_johnson.mp3'},
        {'icon': iconImage,
            'title': 'Walk in Truth 3/1/15 AM - Daniel Smith',
                'file': 'http://www.friendshipbc.net/uploads/2/6/9/7/2697765/3_1_2015_am_daniel_smith.mp3'},
        {'icon': iconImage,
            'title': 'The Voice of Truth 8/17/14 AM Tim Coley',
                'file': 'http://www.friendshipbc.net/uploads/2/6/9/7/2697765/8_17_2014_am_tim_coley.mp3'},
        {'icon': iconImage,
            'title': 'Cultivating the Heart 9/7/14 AM - Rick Johnson',
                'file': 'http://www.friendshipbc.net/uploads/2/6/9/7/2697765/9_7_2014_am_rick_johnson.mp3'},
        {'icon': iconImage,
            'title': 'Five Consequences of Pride 8/10/14 PM - Rick Johnson',
                'file': 'http://www.friendshipbc.net/uploads/2/6/9/7/2697765/8_10_2014_pm_rick_johnson.mp3'}
    ]
});
